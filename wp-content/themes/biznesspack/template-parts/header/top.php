...
$header_status = biznesspack_get_option( 'show_top_header' );
	if ( 1 == $header_status ) {
			...
			$facebook_link  = biznesspack_get_option( 'facebook_link' );
			$twitter_link  = biznesspack_get_option( 'twitter_link' );
			$instagram_link  = biznesspack_get_option( 'instagram_link' );
			$google_link  = biznesspack_get_option( 'google_link' );

			$left_section  	= biznesspack_get_option( 'left_section' );
			$right_section  = biznesspack_get_option( 'right_section' );
